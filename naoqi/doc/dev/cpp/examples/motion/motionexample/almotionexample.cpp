    ...
    const std::string& name): AL::ALModule(broker, name)
{
  ...
  functionName("move", "ALMotionExample", "Moves using the moveToward command and shows control of the arms.");
  BIND_METHOD(ALMotionExample::move);

  functionName("moveCustomization", "ALMotionExample", "Move: Small example to make Nao walk with gait customization. NAO is Keyser Soze.");
  BIND_METHOD(ALMotionExample::moveCustomization);

  functionName("moveFaster", "ALMotionExample", "Move: Small example to make Nao walk Faster (Step of 6 cm)");
  BIND_METHOD(ALMotionExample::moveFaster);

  functionName("moveTo", "ALMotionExample", "Nao walks using the moveTo command and shows odometry.");
  BIND_METHOD(ALMotionExample::moveTo);

  functionName("moveToCustomization", "ALMotionExample", "Move To: Small example to make Nao Walk To an Objective With customization.");
  BIND_METHOD(ALMotionExample::moveToCustomization);

  functionName("moveToDubinsCurve", "ALMotionExample", "Move To: Small example to make Nao Walk follow a Dubins Curve.");
...
void ALMotionExample::move()
{
  ...
  // or disable
  // proxy->setMoveArmsEnabled(false, false)
  ...
  proxy->setMoveArmsEnabled(false, true);
...
void ALMotionExample::moveCustomization()
{
  ...
  proxy->moveToward(x, y, theta, AL::ALValue::array(
  ...
  proxy->moveToward(x, y, theta, AL::ALValue::array(AL::ALValue::array("Frequency", 1.0f)));
  qi::os::msleep(3000);
...
void ALMotionExample::moveFaster()
{
  ...
  proxy->moveToward(x, y, theta, AL::ALValue::array(AL::ALValue::array("Frequency", frequency)));
  qi::os::msleep(3000);

...
#include <alproxies/allandmarkdetectionproxyposthandler.h>
...
class ALLandMarkDetectionProxyImpl;
...
{
  private:
    boost::shared_ptr<ALLandMarkDetectionProxyImpl> fImpl;
    void xInit();
  ...
  public:
    ...
    ALLandMarkDetectionProxy(std::string ip, int port=9559);

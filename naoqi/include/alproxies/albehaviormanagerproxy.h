...
#include <alproxies/albehaviormanagerproxyposthandler.h>
...
{
  private:
    boost::shared_ptr<ALBehaviorManagerProxyImpl> fImpl;
    void xInit();
  ...
  public:
    ...
    ALBehaviorManagerProxy(std::string ip, int port=9559);

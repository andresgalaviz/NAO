...
#include <alproxies/alvisionrecognitionproxyposthandler.h>
...
class ALVisionRecognitionProxyImpl;
...
{
  private:
    boost::shared_ptr<ALVisionRecognitionProxyImpl> fImpl;
    void xInit();
  ...
  public:
    ...
    ALVisionRecognitionProxy(std::string ip, int port=9559);

    /// <summary>
    /// Implements thread wrappers around methods
    /// </summary>
    ALVisionRecognitionProxyPostHandler post;

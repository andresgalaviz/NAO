...
#include <alproxies/albacklightingdetectionproxyposthandler.h>
...
class ALBacklightingDetectionProxyImpl;
...
{
  private:
    boost::shared_ptr<ALBacklightingDetectionProxyImpl> fImpl;
    void xInit();
  ...
  public:
    ...
    ALBacklightingDetectionProxy(std::string ip, int port=9559);

    /// <summary>
    /// Implements thread wrappers around methods
    /// </summary>
    ALBacklightingDetectionProxyPostHandler post;

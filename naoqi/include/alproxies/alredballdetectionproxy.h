...
#include <alproxies/alredballdetectionproxyposthandler.h>
...
class ALRedBallDetectionProxyImpl;
...
{
  private:
    boost::shared_ptr<ALRedBallDetectionProxyImpl> fImpl;
    void xInit();
  ...
  public:
    ...
    ALRedBallDetectionProxy(std::string ip, int port=9559);

    /// <summary>
    /// Implements thread wrappers around methods
    /// </summary>
    ALRedBallDetectionProxyPostHandler post;

...
#include <alproxies/alaudiosourcelocalizationproxyposthandler.h>
...
class ALAudioSourceLocalizationProxyImpl;
...
{
  private:
    boost::shared_ptr<ALAudioSourceLocalizationProxyImpl> fImpl;
    void xInit();
  ...
  public:
    ...
    ALAudioSourceLocalizationProxy(std::string ip, int port=9559);

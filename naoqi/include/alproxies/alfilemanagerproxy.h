// Generated for ALFileManager version 1.14

#ifndef ALFILEMANAGERPROXY_H_
#define ALFILEMANAGERPROXY_H_
#include <alproxies/alfilemanagerproxyposthandler.h>
...
{
  private:
    boost::shared_ptr<ALFileManagerProxyImpl> fImpl;
    void xInit();
  ...
  public:
    ...
    ALFileManagerProxy(std::string ip, int port=9559);

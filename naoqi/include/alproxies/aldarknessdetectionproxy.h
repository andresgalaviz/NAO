...
#include <alproxies/aldarknessdetectionproxyposthandler.h>
...
class ALDarknessDetectionProxyImpl;
...
{
  private:
    boost::shared_ptr<ALDarknessDetectionProxyImpl> fImpl;
    void xInit();
  ...
  public:
    ...
    ALDarknessDetectionProxy(std::string ip, int port=9559);

    /// <summary>
    /// Implements thread wrappers around methods
    /// </summary>
    ALDarknessDetectionProxyPostHandler post;

...
#include <alproxies/alrobotpostureproxyposthandler.h>
...
{
  private:
    boost::shared_ptr<ALRobotPostureProxyImpl> fImpl;
    void xInit();
  ...
  public:
    ...
    ALRobotPostureProxy(std::string ip, int port=9559);

    /// <summary>
    /// Implements thread wrappers around methods
    /// </summary>
    ALRobotPostureProxyPostHandler post;

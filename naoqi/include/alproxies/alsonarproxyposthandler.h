// Generated for ALSonar version 1.14
...
/// ALSonarPostHandler gives acces to all bound methods of the module, using a thread around each call.
...
#endif // ALSONARPROXYPOSTHANDLER_H_

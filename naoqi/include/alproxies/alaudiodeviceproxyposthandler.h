...
#ifndef ALAUDIODEVICEPROXYPOSTHANDLER_H_
#define ALAUDIODEVICEPROXYPOSTHANDLER_H_
...
/// ALAudioDevicePostHandler gives acces to all bound methods of the module, using a thread around each call.
/// Long running tasks can be stopped by calling stop(id) with the id returned by the post.
/// </summary>
/// \ingroup ALProxies
class ALAudioDeviceProxyPostHandler
{
  friend class ALAudioDeviceProxy;
...
#endif // ALAUDIODEVICEPROXYPOSTHANDLER_H_

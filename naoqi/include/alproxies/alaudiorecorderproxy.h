...
#include <alproxies/alaudiorecorderproxyposthandler.h>
...
class ALAudioRecorderProxyImpl;
...
{
  private:
    boost::shared_ptr<ALAudioRecorderProxyImpl> fImpl;
    void xInit();
  ...
  public:
    ...
    ALAudioRecorderProxy(std::string ip, int port=9559);

    /// <summary>
    /// Implements thread wrappers around methods
    /// </summary>
    ALAudioRecorderProxyPostHandler post;

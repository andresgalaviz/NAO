...
#ifndef ALBACKLIGHTINGDETECTIONPROXYPOSTHANDLER_H_
#define ALBACKLIGHTINGDETECTIONPROXYPOSTHANDLER_H_
...
/// ALBacklightingDetectionPostHandler gives acces to all bound methods of the module, using a thread around each call.
/// Long running tasks can be stopped by calling stop(id) with the id returned by the post.
/// </summary>
/// \ingroup ALProxies
class ALBacklightingDetectionProxyPostHandler
{
  friend class ALBacklightingDetectionProxy;
  ...
  /// Long running tasks can be stopped by calling stop(id) with the id returned by the post.
  /// </summary>
  ALBacklightingDetectionProxyPostHandler();
...
#endif // ALBACKLIGHTINGDETECTIONPROXYPOSTHANDLER_H_

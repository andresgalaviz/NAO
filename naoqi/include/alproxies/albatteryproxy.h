...
#include <alproxies/albatteryproxyposthandler.h>
...
{
  private:
    boost::shared_ptr<ALBatteryProxyImpl> fImpl;
    void xInit();
  ...
  public:
    ...
    ALBatteryProxy(std::string ip, int port=9559);

    /// <summary>
    /// Implements thread wrappers around methods
    /// </summary>
    ALBatteryProxyPostHandler post;

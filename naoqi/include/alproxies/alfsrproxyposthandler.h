// Generated for ALFsr version 1.14

#ifndef ALFSRPROXYPOSTHANDLER_H_
#define ALFSRPROXYPOSTHANDLER_H_
...
/// ALFsrPostHandler gives acces to all bound methods of the module, using a thread around each call.
/// Long running tasks can be stopped by calling stop(id) with the id returned by the post.
/// </summary>
/// \ingroup ALProxies
class ALFsrProxyPostHandler
{
  friend class ALFsrProxy;
...
#endif // ALFSRPROXYPOSTHANDLER_H_

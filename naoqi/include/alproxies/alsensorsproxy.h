...
#include <alproxies/alsensorsproxyposthandler.h>
...
{
  private:
    boost::shared_ptr<ALSensorsProxyImpl> fImpl;
    void xInit();
  ...
  public:
    ...
    ALSensorsProxy(std::string ip, int port=9559);

    /// <summary>
    /// Implements thread wrappers around methods
    /// </summary>
    ALSensorsProxyPostHandler post;

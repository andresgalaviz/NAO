...
#include <alproxies/alphotocaptureproxyposthandler.h>
...
{
  private:
    boost::shared_ptr<ALPhotoCaptureProxyImpl> fImpl;
    void xInit();
  ...
  public:
    ...
    ALPhotoCaptureProxy(std::string ip, int port=9559);

    /// <summary>
    /// Implements thread wrappers around methods
    /// </summary>
    ALPhotoCaptureProxyPostHandler post;

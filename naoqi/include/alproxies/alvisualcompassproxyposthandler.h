...
#ifndef ALVISUALCOMPASSPROXYPOSTHANDLER_H_
#define ALVISUALCOMPASSPROXYPOSTHANDLER_H_
...
/// <summary>
/// 
/// ALVisualCompassPostHandler gives acces to all bound methods of the module, using a thread around each call.
/// Long running tasks can be stopped by calling stop(id) with the id returned by the post.
/// </summary>
/// \ingroup ALProxies
class ALVisualCompassProxyPostHandler
{
  friend class ALVisualCompassProxy;
  ...
  /// Long running tasks can be stopped by calling stop(id) with the id returned by the post.
  /// </summary>
  ALVisualCompassProxyPostHandler();
...
#endif // ALVISUALCOMPASSPROXYPOSTHANDLER_H_

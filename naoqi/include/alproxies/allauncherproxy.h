// Generated for ALLauncher version 1.14

#ifndef ALLAUNCHERPROXY_H_
#define ALLAUNCHERPROXY_H_
#include <alproxies/allauncherproxyposthandler.h>
...
{
  private:
    boost::shared_ptr<ALLauncherProxyImpl> fImpl;
    void xInit();
  ...
  public:
    ...
    ALLauncherProxy(std::string ip, int port=9559);

...
#include <alproxies/alvideorecorderproxyposthandler.h>
...
class ALVideoRecorderProxyImpl;
...
{
  private:
    boost::shared_ptr<ALVideoRecorderProxyImpl> fImpl;
    void xInit();
  ...
  public:
    ...
    ALVideoRecorderProxy(std::string ip, int port=9559);

    /// <summary>
    /// Implements thread wrappers around methods
    /// </summary>
    ALVideoRecorderProxyPostHandler post;

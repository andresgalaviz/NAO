// Generated for ALRedBallTracker version 1.14

#ifndef ALREDBALLTRACKERPROXY_H_
#define ALREDBALLTRACKERPROXY_H_
#include <alproxies/alredballtrackerproxyposthandler.h>
...
{
  private:
    boost::shared_ptr<ALRedBallTrackerProxyImpl> fImpl;
    void xInit();
  ...
  public:
    ...
    ALRedBallTrackerProxy(std::string ip, int port=9559);

...
#include <alproxies/alconnectionmanagerproxyposthandler.h>
...
class ALConnectionManagerProxyImpl;
...
{
  private:
    boost::shared_ptr<ALConnectionManagerProxyImpl> fImpl;
    void xInit();
  ...
  public:
    ...
    ALConnectionManagerProxy(std::string ip, int port=9559);

    /// <summary>
    /// Implements thread wrappers around methods
    /// </summary>
    ALConnectionManagerProxyPostHandler post;

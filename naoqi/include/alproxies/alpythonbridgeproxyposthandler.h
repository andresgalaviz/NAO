// Generated for ALPythonBridge version 1.14
...
/// ALPythonBridgePostHandler gives acces to all bound methods of the module, using a thread around each call.
...
class ALPythonBridgeProxyPostHandler
{
  ...
  /// Long running tasks can be stopped by calling stop(id) with the id returned by the post.
  /// </summary>
  ALPythonBridgeProxyPostHandler();
...
#endif // ALPYTHONBRIDGEPROXYPOSTHANDLER_H_

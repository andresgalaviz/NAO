...
#include <alproxies/alnavigationproxyposthandler.h>
...
{
  private:
    boost::shared_ptr<ALNavigationProxyImpl> fImpl;
    void xInit();
  ...
  public:
    ...
    ALNavigationProxy(std::string ip, int port=9559);

    /// <summary>
    /// Implements thread wrappers around methods
    /// </summary>
    ALNavigationProxyPostHandler post;

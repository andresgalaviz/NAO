// Generated for ALFaceDetection version 1.14
...
/// ALFaceDetection is the Module which detects faces. 
    ...
    ///
    /// - Camera_id = id of the active camera (see videodevice documentation)
/// ALFaceDetectionPostHandler gives acces to all bound methods of the module, using a thread around each call.
...
class ALFaceDetectionProxyPostHandler
{
  ...
  /// Long running tasks can be stopped by calling stop(id) with the id returned by the post.
  /// </summary>
  ALFaceDetectionProxyPostHandler();
...
#endif // ALFACEDETECTIONPROXYPOSTHANDLER_H_

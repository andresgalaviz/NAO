...
public:
  /**
     ...
     *@param[4] : [float] camera FOV left angle in radian
     *@param[5] : [float] camera FOV top angle in radian
     *@param[6] : [float] camera FOV right angle in radian
     *@param[7] : [float] camera FOV bottom angle in radian
     */
  ...
  /**
     ...
     *@param[3] : [float] camera FOV left angle in radian
     *@param[4] : [float] camera FOV top angle in radian
     *@param[5] : [float] camera FOV right angle in radian
     *@param[6] : [float] camera FOV bottom angle in radian
     */
  ...
  inline void setTimeStamp(const qi::os::timeval pTimeStamp)
  {
    ...
    setTimeStamp(pTimeStamp.tv_sec, pTimeStamp.tv_usec);
  }
  ...
  /**
     *setTimeStamp
     *@brief set the image timestamp
     *@param[0] : [int] time in seconds
     *@param[1] : [int] time in µseconds
     */
  ...
  /**
     ...
     *@param[0] : [int] ID of the camera that shot the picture
     */
  ...
  { leftAngle = fFOV.leftAngle; topAngle = fFOV.topAngle;
  ...
  //deprecated
  bool computeYUV422imageFromBGR(IplImage* _src); //TODO(pev): replace argument for compatibility with ALImage by data pointer and sizes

...
#include <alproject/alprojecterror.h>
#include <boost/shared_ptr.hpp>
#include <boost/filesystem.hpp>
#include <qiproject/qt/projectmodel.hpp>
...
public:
  ...
  void copyDirectory(const qi::project::ProjectModel& fromProject, const QString& fromRelativePath, const ALPath& toRelativePath) throw(ALProjectError);

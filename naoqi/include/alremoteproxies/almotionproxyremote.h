...
class ALMotionProxyRemote : public ALProxyRemote
{
  public:
    ...
    std::vector<std::string> getBodyNames(const std::string& name)
    {
        ...
        return callRemote<std::vector<std::string> >("getBodyNames" , name);
    }
    ...
    int getMotionCycleTime()
    {
        ...
        return callRemote<int >("getMotionCycleTime");
    }
    ...
    AL::ALValue getMoveConfig(const std::string& config)
    {
        ...
        return callRemote<AL::ALValue >("getMoveConfig" , config);
    }
    ...
    void move(const float& x, const float& y, const float& theta, const AL::ALValue& moveConfig)
    {
        ...
        callVoidRemote("move" , x, y, theta, moveConfig);
    }
    ...
    bool moveIsActive()
    {
        ...
        return callRemote<bool >("moveIsActive");
    }
    ...
    void moveTo(const float& x, const float& y, const float& theta)
    {
        ...
        callVoidRemote("moveTo" , x, y, theta);
    }
    ...
    void moveTo(const float& x, const float& y, const float& theta, const AL::ALValue& moveConfig)
    {
        ...
        callVoidRemote("moveTo" , x, y, theta, moveConfig);
    }
    ...
    void moveTo(const AL::ALValue& controlPoint)
    {
        ...
        callVoidRemote("moveTo" , controlPoint);
    }
    ...
    void moveTo(const AL::ALValue& controlPoint, const AL::ALValue& feetGaitConfig)
    {

        callVoidRemote("moveTo" , controlPoint, feetGaitConfig);
    }
    ...
    void moveToward(const float& x, const float& y, const float& theta)
    {
        ...
        callVoidRemote("moveToward" , x, y, theta);
    }
    ...
    void moveToward(const float& x, const float& y, const float& theta, const AL::ALValue& moveConfig)
    {
        ...
        callVoidRemote("moveToward" , x, y, theta, moveConfig);
    }
    ...
    bool robotIsWakeUp()
    {
        ...
        return callRemote<bool >("robotIsWakeUp");
    }
    ...
    void setWalkArmsEnabled(const bool& leftArmEnabled, const bool& rightArmEnabled)
    {
        ...
        callVoidRemote("setWalkArmsEnabled" , leftArmEnabled, rightArmEnabled);
    }
    ...
    void setWalkTargetVelocity(const float& x, const float& y, const float& theta, const float& frequency, const AL::ALValue& leftFootMoveConfig, const AL::ALValue& rightFootMoveConfig)
    {
        ...
        callVoidRemote("setWalkTargetVelocity" , x, y, theta, frequency, leftFootMoveConfig, rightFootMoveConfig);
    }
    ...
    void waitUntilMoveIsFinished()
    {
        ...
        callVoidRemote("waitUntilMoveIsFinished");
    }

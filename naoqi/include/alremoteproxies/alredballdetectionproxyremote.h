...
#ifndef ALREDBALLDETECTIONPROXYREMOTE_H_
#define ALREDBALLDETECTIONPROXYREMOTE_H_
...
class ALRedBallDetectionProxyRemote : public ALProxyRemote
{
  public:
    ...
    ALRedBallDetectionProxyRemote(std::string pIP, int pPort) : ALProxyRemote("ALRedBallDetection", pIP, pPort)
    {
    ...
    /// </summary>
    ALRedBallDetectionProxyPostHandlerRemote post;

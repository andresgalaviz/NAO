// Generated for ALResourceManager version 1.14
...
class ALResourceManagerProxyRemote : public ALProxyRemote
{
  public:
    ...
    void createResourcesList(const std::vector<std::string>& resourceGroupName, const std::string& resourceName)
    {
        ...
        callVoidRemote("createResourcesList" , resourceGroupName, resourceName);
    }
    ...
    bool isResourceFree(const std::string& resourceNames)
    {
        ...
        return callRemote<bool >("isResourceFree" , resourceNames);
    }
    ...
    AL::ALValue ownersGet()
    {
        ...
        return callRemote<AL::ALValue >("ownersGet");
    }
    ...
    std::vector<std::string> waitForOptionalResourcesTree(const std::vector<std::string>& arg1, const std::string& arg2, const std::string& arg3, const int& arg4, const std::vector<std::string>& arg5)
    {
        ...
        return callRemote<std::vector<std::string> >("waitForOptionalResourcesTree" , arg1, arg2, arg3, arg4, arg5);
    }
    ...
    /// <param name="callbackName"> callback name </param>
    /// <param name="timeoutSeconds"> Timeout in seconds </param>
    void waitForResourcesTree(const std::vector<std::string>& ressourceName, const std::string& ownerName, const std::string& callbackName, const int& timeoutSeconds)
    {

        callVoidRemote("waitForResourcesTree" , ressourceName, ownerName, callbackName, timeoutSeconds);
    }

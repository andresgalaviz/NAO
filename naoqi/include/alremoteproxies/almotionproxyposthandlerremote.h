...
class ALMotionProxyPostHandlerRemote : public ALProxyRemote
{
  ...
  public:
    ...
    {
      return fParent->pCall("move" , x, y, theta);
    }
    ...
    {
      return fParent->pCall("move" , x, y, theta, moveConfig);
    }
    ...
    {
      return fParent->pCall("moveTo" , x, y, theta);
    }
    ...
    {
      return fParent->pCall("moveTo" , x, y, theta, moveConfig);
    }
    ...
    {
      return fParent->pCall("moveTo" , controlPoint);
    }
    ...
    {
      return fParent->pCall("moveTo" , controlPoint, feetGaitConfig);
    }
    ...
    {
      return fParent->pCall("moveToward" , x, y, theta);
    }
    ...
    {
      return fParent->pCall("moveToward" , x, y, theta, moveConfig);
    }
    ...
    {
      return fParent->pCall("setWalkArmsEnabled" , leftArmEnabled, rightArmEnabled);
    }
    ...
    {
      return fParent->pCall("setWalkTargetVelocity" , x, y, theta, frequency, leftFootMoveConfig, rightFootMoveConfig);
    }
    ...
    {
      return fParent->pCall("waitUntilMoveIsFinished");
    }

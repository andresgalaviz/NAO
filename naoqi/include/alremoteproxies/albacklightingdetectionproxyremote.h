...
#ifndef ALBACKLIGHTINGDETECTIONPROXYREMOTE_H_
#define ALBACKLIGHTINGDETECTIONPROXYREMOTE_H_
...
class ALBacklightingDetectionProxyRemote : public ALProxyRemote
{
  public:
    ...
    ALBacklightingDetectionProxyRemote(std::string pIP, int pPort) : ALProxyRemote("ALBacklightingDetection", pIP, pPort)
    {
    ...
    /// </summary>
    ALBacklightingDetectionProxyPostHandlerRemote post;

...
#ifndef ALDARKNESSDETECTIONPROXYPOSTHANDLERREMOTE_H_
#define ALDARKNESSDETECTIONPROXYPOSTHANDLERREMOTE_H_
#include <alremotecall/alremoteproxy.h>

namespace AL
{
class ALDarknessDetectionProxyRemote;

/// <summary>This module enables to detect if the robot is in a dark environment</summary>
class ALDarknessDetectionProxyPostHandlerRemote : public ALProxyRemote
{
    friend class ALDarknessDetectionProxyRemote;
  ...
  public:
    ...
    /// ALDarknessDetectionPostHandlerRemote gives acces to all bound methods of the module, using a thread around each call.
    /// Long running tasks can be stopped by calling stop(id) with the id returned by the post.
    /// </summary>
    ALDarknessDetectionProxyPostHandlerRemote() : fParent(NULL)
    {}
    ...
    {
      return fParent->pCall("setDarknessThreshold" , threshold);
    }
...
#endif // ALDARKNESSDETECTIONPROXYPOSTHANDLERREMOTE_H_

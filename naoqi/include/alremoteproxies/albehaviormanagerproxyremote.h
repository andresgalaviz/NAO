// Generated for ALBehaviorManager version 1.14
...
class ALBehaviorManagerProxyRemote : public ALProxyRemote
{
  public:
    ...
    std::vector<std::string> getBehaviorTags(const std::string& behavior)
    {
        ...
        return callRemote<std::vector<std::string> >("getBehaviorTags" , behavior);
    }
    ...
    std::vector<std::string> getBehaviorsByTag(const std::string& tag)
    {
        ...
        return callRemote<std::vector<std::string> >("getBehaviorsByTag" , tag);
    }
    ...
    std::vector<std::string> getTagList()
    {
        ...
        return callRemote<std::vector<std::string> >("getTagList");
    }
    ...
    bool installBehavior(const std::string& localPath)
    {
        ...
        return callRemote<bool >("installBehavior" , localPath);
    }
    ...
    bool installBehavior(const std::string& absolutePath, const std::string& localPath, const bool& overwrite)
    {
        ...
        return callRemote<bool >("installBehavior" , absolutePath, localPath, overwrite);
    }

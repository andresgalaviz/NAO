...
#ifndef ALDARKNESSDETECTIONPROXYREMOTE_H_
#define ALDARKNESSDETECTIONPROXYREMOTE_H_
...
class ALDarknessDetectionProxyRemote : public ALProxyRemote
{
  public:
    ...
    ALDarknessDetectionProxyRemote(std::string pIP, int pPort) : ALProxyRemote("ALDarknessDetection", pIP, pPort)
    {
    ...
    /// </summary>
    ALDarknessDetectionProxyPostHandlerRemote post;
    ...
    int getDarknessThreshold()
    {
        ...
        return callRemote<int >("getDarknessThreshold");
    }
    ...
    void setDarknessThreshold(const int& threshold)
    {
        ...
        callVoidRemote("setDarknessThreshold" , threshold);
    }

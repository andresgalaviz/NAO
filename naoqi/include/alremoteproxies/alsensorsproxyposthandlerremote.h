// Generated for ALSensors version 1.14


#ifndef ALSENSORSPROXYPOSTHANDLERREMOTE_H_
#define ALSENSORSPROXYPOSTHANDLERREMOTE_H_
#include <alremotecall/alremoteproxy.h>

namespace AL
{
class ALSensorsProxyRemote;
...
class ALSensorsProxyPostHandlerRemote : public ALProxyRemote
{
    friend class ALSensorsProxyRemote;
  ...
  public:
    ...
    /// ALSensorsPostHandlerRemote gives acces to all bound methods of the module, using a thread around each call.
    /// Long running tasks can be stopped by calling stop(id) with the id returned by the post.
    /// </summary>
    ALSensorsProxyPostHandlerRemote() : fParent(NULL)
    {}
...
#endif // ALSENSORSPROXYPOSTHANDLERREMOTE_H_

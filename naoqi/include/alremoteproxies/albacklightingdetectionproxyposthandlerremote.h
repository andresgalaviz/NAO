// Generated for ALBacklightingDetection version 1.14


#ifndef ALBACKLIGHTINGDETECTIONPROXYPOSTHANDLERREMOTE_H_
#define ALBACKLIGHTINGDETECTIONPROXYPOSTHANDLERREMOTE_H_
#include <alremotecall/alremoteproxy.h>

namespace AL
{
class ALBacklightingDetectionProxyRemote;

/// <summary>This module enables to check if the image of the camera is backlit</summary>
class ALBacklightingDetectionProxyPostHandlerRemote : public ALProxyRemote
{
    friend class ALBacklightingDetectionProxyRemote;
  ...
  public:
    ...
    /// ALBacklightingDetectionPostHandlerRemote gives acces to all bound methods of the module, using a thread around each call.
    /// Long running tasks can be stopped by calling stop(id) with the id returned by the post.
    /// </summary>
    ALBacklightingDetectionProxyPostHandlerRemote() : fParent(NULL)
    {}
...
#endif // ALBACKLIGHTINGDETECTIONPROXYPOSTHANDLERREMOTE_H_

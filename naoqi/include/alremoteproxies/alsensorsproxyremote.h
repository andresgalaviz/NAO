...
#ifndef ALSENSORSPROXYREMOTE_H_
#define ALSENSORSPROXYREMOTE_H_
...
class ALSensorsProxyRemote : public ALProxyRemote
{
  public:
    ...
    ALSensorsProxyRemote(std::string pIP, int pPort) : ALProxyRemote("ALSensors", pIP, pPort)
    {
    ...
    /// </summary>
    ALSensorsProxyPostHandlerRemote post;

...
#ifndef ALBONJOURPROXYREMOTE_H_
#define ALBONJOURPROXYREMOTE_H_
...
/// <summary></summary>
class ALBonjourProxyRemote : public ALProxyRemote
{
  public:
    ...
    ALBonjourProxyRemote(std::string pIP, int pPort) : ALProxyRemote("ALBonjour", pIP, pPort)
    {
    ...
    /// </summary>
    ALBonjourProxyPostHandlerRemote post;

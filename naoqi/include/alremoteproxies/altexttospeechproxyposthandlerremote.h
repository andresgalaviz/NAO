...
#ifndef ALTEXTTOSPEECHPROXYPOSTHANDLERREMOTE_H_
#define ALTEXTTOSPEECHPROXYPOSTHANDLERREMOTE_H_
#include <alremotecall/alremoteproxy.h>

namespace AL
{
class ALTextToSpeechProxyRemote;
...
class ALTextToSpeechProxyPostHandlerRemote : public ALProxyRemote
{
    friend class ALTextToSpeechProxyRemote;
  ...
  public:
    ...
    /// ALTextToSpeechPostHandlerRemote gives acces to all bound methods of the module, using a thread around each call.
    /// Long running tasks can be stopped by calling stop(id) with the id returned by the post.
    /// </summary>
    ALTextToSpeechProxyPostHandlerRemote() : fParent(NULL)
    {}
    ...
    {
      return fParent->pCall("disableNotifications");
    }
    ...
    {
      return fParent->pCall("enableNotifications");
    }
    ...
    {
      return fParent->pCall("say" , stringToSay);
    }
    ...
    {
      return fParent->pCall("setParameter" , pEffectName, pEffectValue);
    }
    ...
    {
      return fParent->pCall("setVolume" , volume);
    }
...
#endif // ALTEXTTOSPEECHPROXYPOSTHANDLERREMOTE_H_

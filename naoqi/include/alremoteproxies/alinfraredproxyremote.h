// Generated for ALInfrared version 1.14

#ifndef ALINFRAREDPROXYREMOTE_H_
#define ALINFRAREDPROXYREMOTE_H_
...
class ALInfraredProxyRemote : public ALProxyRemote
{
  public:
    ...
    ALInfraredProxyRemote(std::string pIP, int pPort) : ALProxyRemote("ALInfrared", pIP, pPort)
    {
    ...
    /// </summary>
    ALInfraredProxyPostHandlerRemote post;
    ...
    void confRemoteRecordSave()
    {
        ...
        callVoidRemote("confRemoteRecordSave");
    }
    ...
    void initReception(const int& RepeatThreshold)
    {
        ...
        callVoidRemote("initReception" , RepeatThreshold);
    }
    ...
    void send32(const int& Octet1, const int& Octet2, const int& Octet3, const int& Octet4)
    {
        ...
        callVoidRemote("send32" , Octet1, Octet2, Octet3, Octet4);
    }
    ...
    void sendIpAddress(const std::string& IP)
    {
        ...
        callVoidRemote("sendIpAddress" , IP);
    }
    ...
    void sendRemoteKey(const std::string& Remote, const std::string& Key)
    {
        ...
        callVoidRemote("sendRemoteKey" , Remote, Key);
    }
    ...
    void sendRemoteKeyWithTime(const std::string& Remote, const std::string& Key, const int& pTimeMs)
    {
        ...
        callVoidRemote("sendRemoteKeyWithTime" , Remote, Key, pTimeMs);
    }

...
#ifndef ALLANDMARKDETECTIONPROXYREMOTE_H_
#define ALLANDMARKDETECTIONPROXYREMOTE_H_
...
class ALLandMarkDetectionProxyRemote : public ALProxyRemote
{
  public:
    ...
    ALLandMarkDetectionProxyRemote(std::string pIP, int pPort) : ALProxyRemote("ALLandMarkDetection", pIP, pPort)
    {
    ...
    /// </summary>
    ALLandMarkDetectionProxyPostHandlerRemote post;
